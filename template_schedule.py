...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.rmSelTasksBtn = QtGui.QPushButton(self.centralwidget)
        self.rmSelTasksBtn.setObjectName(_fromUtf8("rmSelTasksBtn"))
        self.gridLayout.addWidget(self.rmSelTasksBtn, 2, 4, 1, 1)
