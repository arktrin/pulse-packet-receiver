...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.gridLayout.addWidget(self.thresholdValSpin, 1, 2, 1, 1)
        ...
        self.gridLayout.addWidget(self.startDateTimeEdit, 1, 0, 1, 1)
        self.addTaskBtn = QtGui.QPushButton(self.centralwidget)
        self.addTaskBtn.setObjectName(_fromUtf8("addTaskBtn"))
        self.gridLayout.addWidget(self.addTaskBtn, 1, 3, 1, 1)
        ...
        self.gridLayout.addWidget(self.endDateTimeEdit, 1, 1, 1, 1)
        self.rmTasksBtn = QtGui.QPushButton(self.centralwidget)
        self.rmTasksBtn.setObjectName(_fromUtf8("rmTasksBtn"))
        self.gridLayout.addWidget(self.rmTasksBtn, 2, 3, 1, 1)
